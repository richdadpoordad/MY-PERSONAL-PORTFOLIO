  ...
  const projects = [
    {
      ...
      category: 'fullstack',
      tags: ['React', 'Node.js', 'MongoDB', 'chapa/telebirr'],
      github: 'https://github.com/richdadpoordad/MY-PERSONAL-PORTFOLIO',
    ...
    },
    {
      ...
      category: 'react',
      tags: ['React', 'java', 'Tailwind', 'telebirr/cbe'],
    ...
    {
      id: 3,
      title: 'Agricultural market place',
      description: 'Agricultural web based application',
      category: 'fullstack',
      tags: ['React ', 'next js','TypeScript','tailwind css','node js','express js','postgresql'],
      github: 'https://github.com',
      live: 'https://demo.com',
      featured: false,
